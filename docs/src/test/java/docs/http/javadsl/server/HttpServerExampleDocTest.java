...
public class HttpServerExampleDocTest {
  ...
  public static void bindingFailureExample() throws Exception {
    ...
    serverBindingFuture.whenCompleteAsync(
        (binding, failure) -> {
        ...
        Flow.of(HttpRequest.class)
            ...
            .map(
                request -> {
                  ...
                  HttpEntity.Chunked entity =
                      HttpEntities.create(ContentTypes.TEXT_PLAIN_UTF8, bytes);
  ...
  public static void fullServerExample() throws Exception {
    ...
    try {
      ...
      serverBindingFuture
          .toCompletableFuture()
          .get(3, TimeUnit.SECONDS); // will throw if binding fails
